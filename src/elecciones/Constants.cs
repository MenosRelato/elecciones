...
public static class Constants
{
    ...
    /// </summary>
    public const string AzureStorageConnection = "DefaultEndpointsProtocol=https;AccountName=menosrelato;BlobEndpoint=https://menosrelato.blob.core.windows.net/;QueueEndpoint=https://menosrelato.queue.core.windows.net/;TableEndpoint=https://menosrelato.table.core.windows.net/;FileEndpoint=https://menosrelato.file.core.windows.net/;";
    public const string AzureStorageUrl = "https://menosrelato.blob.core.windows.net/";
